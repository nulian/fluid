defmodule Liquid.Combinators.Tags.CaseTest do
  ...
  test "case using multiples when" do
    test_combinator(
      ...
      &Parser.case/1,
      [
        {:case, ["condition", {:when, [1, "its 1 "]}, {:when, [2, "its 2 "]}]},
        ""
      ]
    )
  end
  ...
  test "case with a else tag" do
    test_combinator(
      ...
      &Parser.case/1,
      [
        {:case, ["condition", {:when, [5, "hit "]}, {:else, ["else "]}]},
        ""
      ]
    )
  end
    ...
    test_combinator(
      ...
      [
        {:case,
         [
           "condition",
           {:when, [1, ",", "string", ",", "null", "its 1 or 2 or 3 "]},
           {:when, [4, "its 4 "]}
         ]},
        ""
      ]
