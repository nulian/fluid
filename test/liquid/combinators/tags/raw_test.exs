defmodule Liquid.Combinator.Tags.RawTest do
  ...
  test "raw tag parser" do
    test_combinator(
      ...
      &Parser.raw/1,
      [{:raw, [raw_text: ' Raw temporarily disables tag processing. This is useful for generating content (eg, Mustache, Handlebars )like this {{ product }} which uses conflicting syntax.']}, ""]
    )
  end
end
